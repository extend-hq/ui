...
- Review surfaces for annotations, redlines, comparisons, and human-in-the-loop checks.
- Utility panels for OCR text, metadata, extraction status, and validation context.
