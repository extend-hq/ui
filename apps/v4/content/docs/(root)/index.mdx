...
The document-specific React components are maintained in Extend UI. The rest of the base primitives are from [Coss UI](https://coss.com/ui/docs), including the shared button, tooltip, select, popover, dialog, and menu patterns. Icons follow the `iconLibrary` in your `components.json` — the CLI supports [Lucide](https://lucide.dev/), [Tabler](https://tabler.io/icons), [Hugeicons](https://hugeicons.com/), [Phosphor](https://phosphoricons.com/), and [Remix Icon](https://remixicon.com/), and this site renders Hugeicons.
