...
<Step>Copy the shared component dependencies into your project.</Step>

The editor uses Color Picker, Document Viewer Sidebar, and Resizable for its
style controls, thumbnail rail, and resizable panels. Copy these components and
their supporting utilities below.

Install the Resizable package dependency:

```bash
npm install react-resizable-panels@^4.11.2
```

<PdfEditorSource sharedDependencies />
